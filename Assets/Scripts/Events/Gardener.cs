...
public class Gardener : CardEvent
{
    public Gardener()
    {
        ...
        getChoices.Add(new Choice(0,0,0,"Yes",()=> {
            GameManager.AddEventForToday(new Message("YES","The garden is beautiful, people are happy, and some neighbors come to see this. It costs a little bit, but you make even more because people pay to see it","Nice"));
