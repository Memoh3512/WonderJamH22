...
public class AlienSeries2 : CardEvent
{
    public AlienSeries2()
    {
        ...
        getChoices.Add(new Choice(0, 0, 200, "Send more soldier, we'll get to the bottom of this!", () =>
        {
            GameManager.addPlannedEvent(new AlienSeries3());
            return false;
        }));

        getChoices.Add(new Choice(0, 10, -100, "It's better not to get involved, call back the soldiers.", () =>
        {          
            return false;
        }));
    }
